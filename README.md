...
IEEE Senior Member · NeurIPS 2026 reviewer (Datasets & Benchmarks track)

I build evaluation, safety, and observability infrastructure for AI systems.
Active maintainer-engaged contributor across MLflow, Inspect AI, omnigent,
Guardrails AI, TruLens, LlamaIndex, Phoenix, and pydantic-ai.

---

## OSS contributions (last 6 months: 38 merged, 6 open)
...
| [omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent/pulls?q=is%3Apr+author%3Adebu-sinha) | 1 + **6 open** | OTel observability series finishing the auto-tracing surface: GenAI semconv attrs ([#1050](https://github.com/omnigent-ai/omnigent/pull/1050)), TRACEPARENT subprocess injection ([#1070](https://github.com/omnigent-ai/omnigent/pull/1070)), Python logging to OTel bridge ([#1068](https://github.com/omnigent-ai/omnigent/pull/1068)), GenAI metric instruments ([#1072](https://github.com/omnigent-ai/omnigent/pull/1072)), `gen_ai.retry` events ([#1071](https://github.com/omnigent-ai/omnigent/pull/1071)), end-to-end OTLP receiver test ([#1083](https://github.com/omnigent-ai/omnigent/pull/1083)). |
...
- [omnigent-mlflow](https://github.com/debu-sinha/omnigent-mlflow-quickstart) - MLflow tracing adapter for omnigent agents (one span per StreamHooks callback, one trace per turn)
